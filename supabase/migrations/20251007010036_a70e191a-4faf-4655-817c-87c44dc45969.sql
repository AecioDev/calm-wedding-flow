...
-- Enum para tipos de papel do usuário (verificar se não existe)
DO $$ BEGIN
...
CREATE INDEX IF NOT EXISTS idx_guests_organization ON guests(organization_id);
...
-- Políticas RLS para events (continua com mesmo padrão)
DO $$ BEGIN
